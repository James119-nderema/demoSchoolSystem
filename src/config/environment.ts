...
export const ENV = {
  ...
  API: {
    ...
    development: {
      ...
      UPLOAD_TIMEOUT: parseInt(import.meta.env.VITE_UPLOAD_TIMEOUT) || 300000, // 5 minutes for uploads
    ...
    staging: {
      ...
      UPLOAD_TIMEOUT: parseInt(import.meta.env.VITE_UPLOAD_TIMEOUT) || 600000, // 10 minutes for uploads
      NAME: 'Staging Server',
    },
