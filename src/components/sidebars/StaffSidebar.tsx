...
const StaffSidebar: React.FC<StaffSidebarProps> = ({ staffInfo, onLogout }) => {
  ...
  const getAllMenuItems = () => {
    ...
    // Dashboard - Bursar gets Finance Dashboard, others get Staff Dashboard
    ...
    // Report Cards - only Director of Studies and Administrative Staff
    ...
    if (permissions.canViewFinance()) {
      ...
      // Invoices visible to anyone with finance permissions
      financeSubItems.push({
        name: 'Invoices',
